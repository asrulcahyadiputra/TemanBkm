<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title">Jenis Simpanan</h4>
								...
								<div class="card">
									<div class="card-header">
										...
										<div class="d-flex align-items-center">
											<button class="btn btn-primary btn-round ml-auto" data-toggle="modal" data-target="#addJenis">
												...
												<tbody>
													...
													foreach ($jenis as $r) : ?>
														<tr>
															...
															<td>
																<a href="<?= site_url('Jenis_simpanan/update/' . $r->id_jenis) ?>" class="text-primary btn-update">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= site_url('Jenis_simpanan/store') ?>" method="POST">
					<div class="form-group">
						<label for="">ID Jenis Simpanan</label>
						<input type="text" name="id_jenis" id="" value="<?= $kode ?>" class="form-control" readonly>
					</div>
					<div class="form-group">
