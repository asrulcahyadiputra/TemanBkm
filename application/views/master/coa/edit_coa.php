<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title">Update CoA [ <?= $e['akun'] ?> ]</h4>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Form Update CoA</h4>
									</div>
									<div class="card-body">
										<form action="<?= site_url('Coa/update/' . $e['kode_akun']) ?>" method="POST">
											<div class="form-group">
												<label for="">Kode Akun</label>
												<input type="text" name="kode_akun" id="" class="form-control" value="<?= $e['kode_akun'] ?>" readonly>

											</div>
											<div class="form-group">
												<label for="">Nama Akun</label>
												<input type="text" name="akun" id="" class="form-control <?= form_error('akun') != '' ? 'is-invalid' : '' ?>" value="<?= $e['akun'] ?>">
